...
public class JDBCConnection {
    ...
    public static Connection getConnection() {
        ...
        try {
            ...
            dbSys = readEntry(in, "Using Oracle (o) or MySql (m)? (defaults to Oracle)", "o");
        ...
        try {
            if (dbSys.equals("o")) {
                ...
                if (yesNo.equals("y")) {
                    String host = readEntry(in, "host: (Defaults to dbs3.cs.umb.edu) ","dbs3.cs.umb.edu" );
                    if (host == null || host.trim().equals("")){
                        host = "dbs3.cs.umb.edu";
                    }
                    String port = readEntry(in, "port (Defaults to 1521): ","1521");
        ...
        try {
            ...
            System.out.println("Problem with JDBC JDBCConnection\n");
            printSQLException(e);
            //e.printStackTrace();
            System.exit(4);
        } finally {
    ...
    public static void closeConnection(Connection conn) {
        if (conn != null) {
            try {
                ...
                System.out
                        .println("Problem with closing JDBC JDBCConnection\n");
                printSQLException(e);
            }
        }
    }
    ...
    public static String readEntry(Scanner in, String prompt, String defaultString) throws IOException {
